...
public sealed class MenuButton : ContainerButton
{
    ...
    private static readonly Color ColorNormal = Color.FromHex("#ef9805");
    private static readonly Color ColorRedNormal = Color.FromHex("#FEFEFE");
    private static readonly Color ColorHovered = Color.FromHex("#ef9805");
    private static readonly Color ColorRedHovered = Color.FromHex("#FFFFFF");
    private static readonly Color ColorPressed = Color.FromHex("#ef9805");
